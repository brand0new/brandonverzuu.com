<template>
  <!-- Purely decorative — positioned absolutely against app.vue's full-width
       ...
       placed just before Featured Projects in pages/index.vue, so the fade
       always finishes before that section starts regardless of viewport
       size or content reflow. -->
  <canvas
    ref="canvasEl"
    aria-hidden="true"
