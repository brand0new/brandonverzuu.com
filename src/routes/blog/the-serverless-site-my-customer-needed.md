...
description: 'How I came up with a serverless design for a site that is flexible and fulfills the needs of my customer'
keywords: ['serverless', 'customer needs', 'AWS']
