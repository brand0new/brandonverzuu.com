...
<div>
	...
	<div class="mt-3">
		<p>
			Van tijd tot tijd schrijf ik een blogposts over een onderwerp dat ik interessant vind.
			Hiervoor heb ik geen vast schema, maar updates worden verstuurd via LinkedIn.
		</p>
		<p>Lees ze!</p>
	</div>
	<div class="divider" />
