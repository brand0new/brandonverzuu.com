...
// bytes directly) avoids the midtone bias error diffusion is prone to
// otherwise — a very light pixel and a very dark one shouldn't both look
// "wrong" by the same visual amount when a naive gamma-encoded threshold
// is used.
...
/**
 * @param {Buffer|Uint8Array} rgba - interleaved RGBA (or RGB), 8-bit/channel.
